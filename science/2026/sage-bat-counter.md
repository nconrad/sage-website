---
sidebar_position: 8
sidebar_label: Sage Bat Counter
keywords:
  - Sage Summer Camp
  - Bats
  - Computer Vision
...
![Thermal video of bats](../imgs/summer-camp/sage-bat-counter/thermal-video-bats.png)
...
![Original inference pipeline with Sage plugin wrapper](../imgs/summer-camp/sage-bat-counter/sage-bat-counter-flowchart.jpg)
...
![Resulting data from test video on a Sage node](../imgs/summer-camp/sage-bat-counter/test-results.png)
